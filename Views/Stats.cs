    ...
    public partial class Stats : MetroFramework.Forms.MetroForm {
        ...
        public StatSummary GetLevelInfo(string name, int levelException) {
            ...
            if (matches.Count > 0) { // user creative round
                List<RoundInfo> filteredInfo = this.AllStats.FindAll(r => r.Profile == this.currentProfile && r.Name.Equals("wle_s10_user_creative_race_round") && r.ShowNameId.Equals(name));
                int lastShow = -1;
        ...
        private void menuUpdate_Click(object sender, EventArgs e) {
            try {
                ...
                MetroMessageBox.Show(this, ex.Message, $"{Multilingual.GetWord("message_update_error_caption")}",
                    MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
