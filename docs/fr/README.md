...
### Comment Overlay l'image d'arrière-plan personnalisée
  - **Étape 1.** [Téléchargez](https://raw.githubusercontent.com/ShootMe/FallGuysStats/master/Properties/original_image_for_overlay.zip) l'image originale de la superposition.
