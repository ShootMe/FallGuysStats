    ...
    public class TransparentLabel : Label {
        ...
        private float GetFontSizeFactor() {
            switch (this.Name) {
                ...
                case "lblStreak":
                    return (Stats.CurrentLanguage == 0 || Stats.CurrentLanguage == 1) ? (this.TextRight.Length > 10 ? (1f - ((this.TextRight.Length - 30 + (this.Text.Length * 2.5f)) / 100f)) : 1f) :
                ...
                case "lblQualifyChance":
                    return (Stats.CurrentLanguage == 0 || Stats.CurrentLanguage == 1) ? (this.TextRight.Length > 17 ? (1f - ((this.TextRight.Length - 30 + (this.Text.Length * 2.5f)) / 100f)) : 1f) :
