    ...
    public class TransparentLabel : Label {
        ...
        private float GetFontSizeFactor() {
            switch (this.Name) {
                ...
                case "lblFinish":
                    return (this.TextRight.Length > 15 && Stats.CurrentLanguage == 0) ? 0.77f : (this.TextRight.Length > 15 && Stats.CurrentLanguage == 1) ? 0.73f : (this.TextRight.Length == 15 && Stats.CurrentLanguage == 1) ? 0.92f : (this.TextRight.Length > 13 && Stats.CurrentLanguage == 4) ? 0.96f : 1;
                default:
                    return 1f;
            }
        }
